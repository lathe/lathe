...
(def my.mappending (func iterable)
...
(def my.iter-range (start finish (o step 1))
  (when (in step 0 0.0)
...
(def my.iter*sum-grouped-colexico iterables
...
(def my.iter-some (func iterable)
